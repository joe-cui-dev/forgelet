...
Usage:
  ...
  forge browser profiles approve [--name <name>]
  forge browser profiles list
  forge browser profiles set-default <profileId>
  forge browser profiles revoke <profileId>
