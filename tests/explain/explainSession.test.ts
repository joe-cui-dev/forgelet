  ...
  await writeFile(
    ...
    [
      ...
      event("conversation_compacted", {
        compactedCount: 2,
        beforeObservationBytes: 20_000,
        afterObservationBytes: 8_000,
        residualOverageBytes: 0,
      }),
      event("conversation_compaction_attempted", {
        compactedCount: 0,
        beforeObservationBytes: 9_000,
        afterObservationBytes: 9_000,
        residualOverageBytes: 1_000,
      }),
      event("conversation_compacted", {
        compactedCount: 1,
        beforeObservationBytes: 15_000,
        afterObservationBytes: 7_000,
